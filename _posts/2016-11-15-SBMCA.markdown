...
<table cellpadding="4" cellspacing="10" align="left">
  <tr>
  <td colspan="3" > <div align="center" style="margin-top:-80px;"> <strong>Original Mixture</strong></div><br>
  <img align="center" style="width:500px;display:block;margin-left: auto;margin-right: auto;margin-top:-10px;" src="/docs/sbmca_asilomar_data/OrigMix.png" /> <br>
...
# Conclusions
We motivate and propose a technique to solve the single channel semi-blind source separation problem via Semi-Blind Morphological Component Analysis. We base our discussion on intuition and motivating examples from day to day life. For a deeper analysis, algorithmic details and the results please see [SBMCA12].

\cite{StarckED05, MicroLoc10, BobinSFMD07, SBMCA12}
[ICA]:		   https://www.msi.umn.edu

[UMTC]:        https://twin-cities.umn.edu
[DL10]:      http://jekyllrb.com
